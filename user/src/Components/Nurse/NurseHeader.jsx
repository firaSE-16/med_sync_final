      ...
      >
        ...
        {isOpen && (
          ...
          >
            <div className="p-4">
              {/* Nurse's Information */}
              <div className="text-lg font-semibold text-[#04353D]">Nurse Jane Doe</div>
              <div className="text-sm text-gray-600">Experience: 5 years</div>
              <div className="text-sm text-gray-600">Specialization: General Nursing</div>

              {/* Feedback Section */}
              <div className="mt-2 text-sm text-gray-600">
                <strong>Feedback:</strong> "Highly recommended for her care and dedication."
              </div>
