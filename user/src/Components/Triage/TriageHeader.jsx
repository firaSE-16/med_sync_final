    ...
    <div className="bg-white px-6 py-4 flex items-center justify-between shadow-lg">
      ...
      >
        ...
        {isOpen && (
          ...
          >
            <div className="p-4">
              {/* Laboratorist's Information */}
              <div className="text-lg font-semibold text-[#04353D]">Triage John Doe</div>
              <div className="text-sm text-gray-600">Experience: 7 years</div>
              <div className="text-sm text-gray-600">Specialization: Triage</div>

              {/* Feedback Section */}
              <div className="mt-2 text-sm text-gray-600">
                <strong>Feedback:</strong> "Highly skilled in diagnostic testing and accurate results."
              </div>
