      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-7 mx-7">
        ...
        <div className="flex-1">
          <img
            ...
            alt="Menelik Hospital"
          />
        </div>

        {/* Right Section: Information */}
        <div className="contact-info flex-1 p-5 bg-white rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-gray-800 mb-3">Our Hospital</h2>
          <p className="text-gray-600">Menelik II Referral Hospital</p>
          <p className="text-gray-600">Addis Ababa, Ethiopia</p>
          <p className="text-gray-600">
            <strong>Phone:</strong> +251 11 123 4567
          </p>
          <p className="text-gray-600">
            <strong>Email:</strong> info@menelikhospital.et
          </p>

          <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
            Services at Menelik Hospital
          </h2>
          <p className="text-gray-600">Learn more about our teams and job openings.</p>
          <button className="mt-4 px-6 py-2 bg-mygreen text-white rounded-lg hover:bg-blue-600 transition" onClick={(e)=>navigate('/department')}>
            Find Our Doctors
          </button>
        </div>
      </div>
